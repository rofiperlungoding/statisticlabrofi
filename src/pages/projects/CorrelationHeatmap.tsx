  ...
  return (
    <div className="container-main section-padding">
      <div className="text-center mb-12">
        <h1 className="text-title text-primary mb-4">Correlation Heatmap Tool</h1>
        <p className="text-body text-secondary max-w-2xl mx-auto">
          Generate correlation matrices and heatmaps with interactive scatter plot exploration.
        </p>
      </div>
